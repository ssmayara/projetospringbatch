...
public class GrupoLancamentoReader implements ItemStreamReader<GrupoLancamento>,
    ResourceAwareItemReaderItemStream<GrupoLancamento> {
  ...
  private boolean isLancamentoRelacionado(GrupoLancamento grupoLancamento,
      GrupoLancamento proxLancamento) {
